    ...
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Exams != null ? 
                          ...
                          Problem("Entity set 'ExamContext.Exams'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LessonId,StudentId,ExamDate,Score")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LessonId,StudentId,ExamDate,Score")] Exam exam)
        {
            if (id != exam.Id)
            {
                return NotFound();
